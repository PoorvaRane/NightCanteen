...
public class MainFrame extends JFrame {
	...
	private JScrollPane getItemButtons() {
		...
		for (final MenuItem itemButton: itemButtons) {
                        ...
                        String str=itemButton.getName()+".jpg";
                        ImageIcon icon=new ImageIcon(str);
                        final javax.swing.JButton createButton = new javax.swing.JButton(itemButton.getName(),icon);
                        createButton.setToolTipText(itemButton.getName()+" - "+itemButton.getCost());			
	...
	private JPanel getReceipt() {
		...
		orderPrice.setText("Total Cost = Rs 0.00");
		...
		placeOrder.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				 ...
				 */
				try {
					if (!orderPrice.getText().equals("Total Cost = Rs 0.00")) {
	...
	private void refreshPanel(final MenuItem itemButton) {
		...
		orderPrice.setText("Total cost = Rs " + totalCost);
	}
